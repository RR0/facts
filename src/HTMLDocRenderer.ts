...
export class HTMLDocRenderer extends HTMLRenderer<any> {
  ...
  readonly foundationRenderer = new HTMLFoundationEventRenderer(this.translation, this.peopleRenderer, this.orgRenderer,
    this.timeRenderer, this.placeRenderer, this.occupationRenderer)
  readonly eventRenderer = new HTMLEventRenderer(this.translation, this.placeRenderer, this.timeRenderer,
    this.occupationRenderer, this.birthEventRenderer, this.foundationRenderer, this.studyRenderer)
